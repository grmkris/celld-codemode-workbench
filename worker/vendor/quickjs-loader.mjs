var QuickJSRaw = (() => {
  ...
  return function (moduleArg = {}) {
    ...
    var ca = c.print || console.log.bind(console),
      A = c.printErr || console.error.bind(console);
    Object.assign(c, u);
    u = null;
    ...
    var ha = (a) => a.startsWith("data:application/octet-stream;base64,"),
      O;
    function ia(a) {
    ...
    var P = (a) => {
      ...
      pa = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335],
      qa = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
      S = {},
      ra = (a) => {
    ...
    var U = (a, b, d) => {
      ...
      Ca = {
        b: (a, b, d, e) => {
          N(
            `Assertion failed: ${a ? R(F, a) : ""}, at: ` +
              [
                b ? (b ? R(F, b) : "") : "unknown filename",
                d,
                e ? (e ? R(F, e) : "") : "unknown function",
              ],
          );
        },
        q: () => {
        ...
        j: function (a, b, d) {
          a = new Date(
            1e3 * ((b + 2097152) >>> 0 < 4194305 - !!a ? (a >>> 0) + 4294967296 * b : NaN),
          );
          G[d >> 2] = a.getSeconds();
          ...
          b = a.getFullYear();
          G[(d + 28) >> 2] =
            ((0 !== b % 4 || (0 === b % 100 && 0 !== b % 400) ? qa : pa)[a.getMonth()] +
              a.getDate() -
              1) |
            0;
        ...
        m: (a) => {
          ...
          for (var d = 1; 4 >= d; d *= 2) {
            ...
            a: {
              e =
                (Math.min(2147483648, 65536 * Math.ceil(Math.max(a, e) / 65536)) -
                  t.buffer.byteLength +
                  65535) /
                65536;
              try {
      ...
      Y = (function () {
        ...
        O ||= c.locateFile
          ? ha("emscripten-module.wasm")
            ? "emscripten-module.wasm"
            : c.locateFile
              ? c.locateFile("emscripten-module.wasm", x)
              : x + "emscripten-module.wasm"
    ...
    c._QTS_DefineProp = (a, b, d, e, g, h, k, l, v) =>
      (c._QTS_DefineProp = Y.ha)(a, b, d, e, g, h, k, l, v);
    c._QTS_GetOwnPropertyNames = (a, b, d, e, g) =>
      (c._QTS_GetOwnPropertyNames = Y.ia)(a, b, d, e, g);
    ...
    c._QTS_RuntimeDisableInterruptHandler = (a) =>
      (c._QTS_RuntimeDisableInterruptHandler = Y.Da)(a);
    ...
    function Ea() {
      ...
      if (!(0 < K)) {
        if (c.preRun)
          for ("function" == typeof c.preRun && (c.preRun = [c.preRun]); c.preRun.length;) fa();
        P(J);
        0 < K ||
          (c.setStatus
            ? (c.setStatus("Running..."),
